...
def android(res_dir):
    ...
    xxhdpi_path = res_dir + "/mipmap-xxhdpi/"  
  
    if not os.path.isdir(xxhdpi_path):  
        print("xxhdpi_path must be a dir")  
        return -1  
  
    path_resize(xxhdpi_path, res_dir + '/mipmap-xhdpi', 0.667)  
    path_resize(xxhdpi_path, res_dir + '/mipmap-hdpi', 0.444)  
    path_resize(xxhdpi_path, res_dir + '/mipmap-mdpi', 0.296)  
